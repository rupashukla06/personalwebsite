...
import { SiExpress, SiMongodb, SiTypescript, SiRedis, SiRabbitmq ,SiPython ,SiMysql ,SiDjango} from "react-icons/si";
    ...
    <>
      <div className="w-screen px-6 py-6 self-center text-center">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-8 gap-x-6 lg:px-[10rem] bg-[#1c1425] py-3">
            ...
            <div className="p-4">  <div className="flex justify-center"> <SiMysql className="self-center text-[3rem] font-normal text-center text-gray-600 hover:fill-blue-600" /></div> <div className="text-gray-100 text-[1.3rem] font-semibold"> Mysql </div>  </div>
            ...
            <div className="p-4">  <div className="flex justify-center"> <SiPython className="self-center text-[3rem] font-normal text-center text-gray-600  hover:fill-indigo-600" /></div> <div className="text-gray-100 text-[1.3rem] font-semibold"> Python </div>  </div>
            ...
            <div className="p-4">  <div className="flex justify-center"> <SiRedis className="self-center text-[3rem] font-normal text-center text-gray-600 hover:fill-green-600" /></div> <div className="text-gray-100 text-[1.3rem] font-semibold"> Redis</div>  </div>
            <div className="p-4">  <div className="flex justify-center"> <SiRabbitmq className="self-center text-[3rem] font-normal text-center text-gray-600 hover:fill-green-600" /></div> <div className="text-gray-100 text-[1.3rem] font-semibold"> Rabbitmq </div>  </div>
            <div className="p-4">  <div className="flex justify-center"> <SiDjango className="self-center text-[3rem] font-normal text-center text-gray-600 hover:fill-green-600" /></div> <div className="text-gray-100 text-[1.3rem] font-semibold"> Django </div>  </div>
